...
def main():
    # model = "opt_1.3b"
    model = "llama_2_7b"
    TASK = "lvwerra/stack-exchange-paired"#"Dahoas/rm-static"
    ...
    if TASK == "Dahoas/rm-static":
        ...
        all_datasets_path = "lvwerra/stack-exchange-paired/data/rl" #Dataset.File.from_files(path=[(ds, "rlhf_datasets/lvwerra/stack-exchange-paired/data/rl")],validate=True).as_mount()
    ...
    def train_pipeline():
        ...
        if sft_model_weights_input is None:
            ...
            trainer.outputs.output_dir.configure(
                mode="mount",
                path_on_datastore=output_path + "/stackxLlama2/sft",
                datastore=ds
            )
        ...
        if ppo_baseline_input is None:
            ...
            ppo.outputs.output_dir.configure(
                mode="mount",
                path_on_datastore=output_path + "/stackxLlama2/ppo",
                datastore=ds
            )
